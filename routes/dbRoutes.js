...
var mongoModel = require("../models/dbModel.js")
...
exports.init = function(app) {
  ...
  // CRUD functionality
  app.put('/db/:collection', doCreate); // CRUD Create
  app.get('/db/:collection', doRetrieve); // CRUD Retrieve
  app.post('/db/:collection', doUpdate); // CRUD Update
  app.delete('/db/:collection', doDelete); // CRUD Delete
}

homepage = function(req, res) {
  res.render('index', {title: 'Movie Roaming'})
};

myMovies = function(req, res){
  console.log('in the get movie function???')
  console.log(req, res)
...
doDelete = function(req, res){
	mongoModel.delete (req.params.collection, 
                      ...
                      function(result) {
                        ...
                        res.render('message', {title: 'Movie Demo', obj: success});
                      });
}